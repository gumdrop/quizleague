...
//implicit val teamDecoder: Codec[Team] = deriveCodec
//  implicit val teamEncoder: Encoder[Team] = deriveEncoder
//implicit val fixturesDecoder: Codec[Fixtures] = deriveCodec
//implicit val fixtureEncoder: Codec[Fixture] = deriveCodec
...
//  implicit val nestedDomainContainerDecoder: Decoder[NestedDomainContainer] = deriveDecoder
...
//  implicit val calendarCacheEncoder: Encoder[CalendarCache] = deriveEncoder
//  implicit val calendarCacheDecoder: Decoder[CalendarCache] = deriveDecoder
